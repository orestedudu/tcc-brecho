        ...
        <div className="bk-page">
            ...
            <div className="bk-tag-wrap">
                ...
                <div className="bk-card">
                    ...
                    <h1 className="bk-brand">Editar categoria</h1>

                    <form onSubmit={handleSubmit} noValidate>
                        {mensagem && (
                            <p className={`bk-mensagem ${mensagem.includes('Erro') || mensagem.includes('não encontrada') ? 'bk-erro' : ''}`}>
                                {mensagem}
                            </p>
                        )}
                        ...
                        <div className="bk-group">
                            <label htmlFor="descricao" className="bk-label">Descrição</label>
                            <textarea
                                id="descricao"
